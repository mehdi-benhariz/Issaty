...
export class AdminDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('issatyApp.admin.delete.question'));
...
export default class AdminComponentsPage {
  ...
  async deleteAdmin() {
    ...
    expect(await adminDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/issatyApp.admin.delete.question/);
