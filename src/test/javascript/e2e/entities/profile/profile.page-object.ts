...
export class ProfileDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('issatyApp.profile.delete.question'));
...
export default class ProfileComponentsPage {
  ...
  async deleteProfile() {
    ...
    expect(await profileDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/issatyApp.profile.delete.question/);
