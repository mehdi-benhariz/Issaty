...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_PROFILE: 'profile/PARTIAL_UPDATE_PROFILE',
...
export default (state: ProfileState = initialState, action): ProfileState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PROFILE):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PROFILE):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PROFILE):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IProfile> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_PROFILE,
