  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="issatyApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="issatyApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : departmentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="department-name" data-cy="name" type="text" name="name" />
              </AvGroup>
