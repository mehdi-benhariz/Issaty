...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_SUBJECT: 'subject/PARTIAL_UPDATE_SUBJECT',
...
export default (state: SubjectState = initialState, action): SubjectState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_SUBJECT):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_SUBJECT):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_SUBJECT):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<ISubject> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_SUBJECT,
