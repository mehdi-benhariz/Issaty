 ...
 */
declare function generateEntityClientFields(primaryKey: string, fields: any[] | any, relationships: any[] | any, dto: string, customDateType?: string | undefined, embedded?: boolean, clientFramework?: string): string[];
