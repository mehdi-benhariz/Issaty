...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'issaty';
  ...
  'jhipster.mail.from' = 'issaty@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'issaty API';
  'jhipster.swagger.description' = 'issaty API documentation';
  ...
  'eureka.instance.appname' = 'issaty';
  'eureka.instance.instanceId' = 'issaty:${random.value}';
