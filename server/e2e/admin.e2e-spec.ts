...
describe('Admin Controller', () => {
    ...
    it('/GET all admins ', async () => {
        ...
        const getEntities: AdminDTO[] = (await request(app.getHttpServer())
        .get('/api/admins')
        .expect(200)).body;
    ...
    it('/GET admins by id', async () => {
        ...
        const getEntity: AdminDTO = (await request(app.getHttpServer())
    ...
    it('/POST create admins', async () => {
        ...
        const createdEntity: AdminDTO = (await request(app.getHttpServer())
            .post('/api/admins')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update admins', async () => {
        ...
        const updatedEntity: AdminDTO = (await request(app.getHttpServer())
            .put('/api/admins')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE admins', async () => {
        ...
        const deletedEntity: AdminDTO = (await request(app.getHttpServer())
