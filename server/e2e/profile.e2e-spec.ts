...
describe('Profile Controller', () => {
    ...
    it('/GET all profiles ', async () => {
        ...
        const getEntities: ProfileDTO[] = (await request(app.getHttpServer())
        .get('/api/profiles')
        .expect(200)).body;
    ...
    it('/GET profiles by id', async () => {
        ...
        const getEntity: ProfileDTO = (await request(app.getHttpServer())
    ...
    it('/POST create profiles', async () => {
        ...
        const createdEntity: ProfileDTO = (await request(app.getHttpServer())
            .post('/api/profiles')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update profiles', async () => {
        ...
        const updatedEntity: ProfileDTO = (await request(app.getHttpServer())
            .put('/api/profiles')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE profiles', async () => {
        ...
        const deletedEntity: ProfileDTO = (await request(app.getHttpServer())
