...
describe('Student Controller', () => {
    ...
    it('/GET all students ', async () => {
        ...
        const getEntities: StudentDTO[] = (await request(app.getHttpServer())
        .get('/api/students')
        .expect(200)).body;
    ...
    it('/GET students by id', async () => {
        ...
        const getEntity: StudentDTO = (await request(app.getHttpServer())
    ...
    it('/POST create students', async () => {
        ...
        const createdEntity: StudentDTO = (await request(app.getHttpServer())
            .post('/api/students')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update students', async () => {
        ...
        const updatedEntity: StudentDTO = (await request(app.getHttpServer())
            .put('/api/students')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE students', async () => {
        ...
        const deletedEntity: StudentDTO = (await request(app.getHttpServer())
