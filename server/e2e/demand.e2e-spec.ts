...
describe('Demand Controller', () => {
    ...
    it('/GET all demands ', async () => {
        ...
        const getEntities: DemandDTO[] = (await request(app.getHttpServer())
        .get('/api/demands')
        .expect(200)).body;
    ...
    it('/GET demands by id', async () => {
        ...
        const getEntity: DemandDTO = (await request(app.getHttpServer())
    ...
    it('/POST create demands', async () => {
        ...
        const createdEntity: DemandDTO = (await request(app.getHttpServer())
            .post('/api/demands')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update demands', async () => {
        ...
        const updatedEntity: DemandDTO = (await request(app.getHttpServer())
            .put('/api/demands')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE demands', async () => {
        ...
        const deletedEntity: DemandDTO = (await request(app.getHttpServer())
