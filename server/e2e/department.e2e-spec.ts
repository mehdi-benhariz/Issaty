...
describe('Department Controller', () => {
    ...
    it('/GET all departments ', async () => {
        ...
        const getEntities: DepartmentDTO[] = (await request(app.getHttpServer())
        .get('/api/departments')
        .expect(200)).body;
    ...
    it('/GET departments by id', async () => {
        ...
        const getEntity: DepartmentDTO = (await request(app.getHttpServer())
    ...
    it('/POST create departments', async () => {
        ...
        const createdEntity: DepartmentDTO = (await request(app.getHttpServer())
    ...
    it('/PUT update departments', async () => {
        ...
        const updatedEntity: DepartmentDTO = (await request(app.getHttpServer())
            .put('/api/departments')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE departments', async () => {
        ...
        const deletedEntity: DepartmentDTO = (await request(app.getHttpServer())
