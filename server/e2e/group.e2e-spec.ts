...
describe('Group Controller', () => {
    ...
    it('/GET all groups ', async () => {
        ...
        const getEntities: GroupDTO[] = (await request(app.getHttpServer())
        .get('/api/groups')
        .expect(200)).body;
    ...
    it('/GET groups by id', async () => {
        ...
        const getEntity: GroupDTO = (await request(app.getHttpServer())
    ...
    it('/POST create groups', async () => {
        ...
        const createdEntity: GroupDTO = (await request(app.getHttpServer())
            .post('/api/groups')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update groups', async () => {
        ...
        const updatedEntity: GroupDTO = (await request(app.getHttpServer())
            .put('/api/groups')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE groups', async () => {
        ...
        const deletedEntity: GroupDTO = (await request(app.getHttpServer())
