...
describe('Teacher Controller', () => {
    ...
    it('/GET all teachers ', async () => {
        ...
        const getEntities: TeacherDTO[] = (await request(app.getHttpServer())
        .get('/api/teachers')
        .expect(200)).body;
    ...
    it('/GET teachers by id', async () => {
        ...
        const getEntity: TeacherDTO = (await request(app.getHttpServer())
    ...
    it('/POST create teachers', async () => {
        ...
        const createdEntity: TeacherDTO = (await request(app.getHttpServer())
            .post('/api/teachers')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update teachers', async () => {
        ...
        const updatedEntity: TeacherDTO = (await request(app.getHttpServer())
            .put('/api/teachers')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE teachers', async () => {
        ...
        const deletedEntity: TeacherDTO = (await request(app.getHttpServer())
