...
describe('Subject Controller', () => {
    ...
    it('/GET all subjects ', async () => {
        ...
        const getEntities: SubjectDTO[] = (await request(app.getHttpServer())
        .get('/api/subjects')
        .expect(200)).body;
    ...
    it('/GET subjects by id', async () => {
        ...
        const getEntity: SubjectDTO = (await request(app.getHttpServer())
    ...
    it('/POST create subjects', async () => {
        ...
        const createdEntity: SubjectDTO = (await request(app.getHttpServer())
            .post('/api/subjects')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update subjects', async () => {
        ...
        const updatedEntity: SubjectDTO = (await request(app.getHttpServer())
            .put('/api/subjects')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE subjects', async () => {
        ...
        const deletedEntity: SubjectDTO = (await request(app.getHttpServer())
